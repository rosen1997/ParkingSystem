...
{
    public class VehicleTypeManager : RepositoryBase<VehicleType>, IVehicleTypeManager
    {
        public VehicleTypeManager(RepositoryContext repositoryContext) : base(repositoryContext)
        {
        }
    }
}
